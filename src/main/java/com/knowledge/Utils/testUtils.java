...
import com.knowledge.Utils.CommonUtilsPackage.idStrcuts;
                ...
                if (!drivings.contains(new idStrcuts(before.getId(), after.getId())) && !run.hasNext()) {
                    ...
                    try {
                        ...
                        if (mapBeans.getStatus() == 0) {
                            ...
                            LogsUtils.WriteTheDataToFile(before.getId() + " " + after.getId(), "drivingexclusive.txt");
                            continue;
                        } else {
                            LogsUtils.WriteTheDataToFile(before.getId() + "  " + after.getId() + "\n" + "\n\n", "drivingStatus.txt");
                            continue;
                ...
                if (!walkings.contains(new idStrcuts(before.getId(), after.getId())) && !run.hasNext()) {
                    ...
                    try {
                        ...
                        if (mapBeans.getStatus() == 0) {
                            ...
                            LogsUtils.WriteTheDataToFile(before.getId() + " " + after.getId(), "walkingexclusive.txt");
                            continue;
                        } else {
                ...
                public Object execute(Transaction transaction) {
                    ...
                    while (run.hasNext()) {
                        try {
                            ...
                            LogsUtils.WriteTheDataToFile(ex.getMessage(), "Shopping.txt");
                        } catch (Exception ex) {
                        } finally {
                        }
                    }
